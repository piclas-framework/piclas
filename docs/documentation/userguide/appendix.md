...
|  SC | 2.0.0 (Nov 2021) |  boltzhawk  |  3.17.0  |  gcc9.3.0 | openmpi-3.1.6              | 1.10.5 |   -    |
|  SC | 2.0.0 (Nov 2021) | boltzreggie |  3.15.0  |  gcc9.2.0 | openmpi-4.0.2              | 1.10.5 |   -    |
|  SC | 2.0.0 (Nov 2021) |  boltzplatz |  3.17.0  |  gcc9.2.0 | openmpi-3.1.6              | 1.10.5 |   -    |
|  SC | 2.0.0 (Nov 2021) |     hawk    |  3.16.4  |  gcc9.2.0 |    mpt2.23                 | 1.10.5 |   -    |
|  SC | 2.0.0 (Nov 2021) |     fh1     |   3.17   | intel18.1 |    impi2018                |  1.10  |   -    |
...
| Dev |  PICLas Version  |    System   |   CMake  | Compiler  |            MPI             |  HDF5  |  PETSc |                                            Notes                                            |
| --- | :--------------: | :---------: | :------: | :-------: | :------------------------: | :----: | :----: | :-----------------------------------------------------------------------------------------: |
|  SC | 4.0.0 (Oct 2025) | boltzreggie | 3.31.1   | gcc15.2.0 | openmpi-5.0.8, mpich-4.3.1 | 1.14.6 | 3.23.6 | piclas fails to compile with gcc 15.2.0 with the error “recompile with -FPIC”               |
|  SC | 4.0.0 (Oct 2025) | boltzreggie | 3.31.1   | gcc15.2.0 | openmpi-5.0.8, mpich-4.3.1 | 1.14.6 | 3.22.5 | petsc fails to configure 3.22.5 with gcc 15.2.0 with Error running make on  SCALAPACK       |
|  SC | 1.4.0 (Nov 2019) | boltzreggie | 3.15.3-d | gcc9.2.0  | openmpi-4.0.1              | 1.10.5 |   -    | Does not work for more than 3 processors probably due to a problem with the OpenMPI version |
|     |                  |             |          |           |                            |        |        |                                                                                             |

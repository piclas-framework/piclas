...
"init-real=nan -fbacktrace -DPP_TimeDiscMethod=5 -DPP_NodeType=1 -DPP_Riemann=1 -DPP_nVar=8 -DPP_nElems=NELEMZ -DPP_N=N -"//&
"DPARTICLES=T -DMPI -DGNU -I. -I/opt/hdf5/hdf5-1.8.14/gnu48/include/ "

  ...
  DO i = 1,PDM%ParticleVecLengthOld
    ...
    ELSE IF (PRESENT(WithOutMPIParts)) THEN
      ...
      ELSE
        ...
        IF (VarTimeStep%UseVariableTimeStep) VarTimeStep%ParticleTimeStep(i) = CalcVarTimeStep(PartState(1,i),PartState(2,i),ElemID)
      END IF
#endif
    ELSE
...
!===================================================================================================================================
!> Calculation of the particle position and rotation of the velocity vector in the case of 1D, 2D, and/or axisymmetric simulation
!===================================================================================================================================
! MODULES
USE MOD_Globals

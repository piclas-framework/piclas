...
USE MOD_SurfaceModel_Vars         ,ONLY: nPorousBC, SurfChemReac , ChemWallProp, ChemSampWall, ChemCountReacWall !, RecombModel
...
CASE(20)
  ...
  ! Determination of the particle weights and MPF

...
USE MOD_Particle_Vars           ,ONLY: PEM, PartState, PartPosRef,Species,WriteMacroVolumeValues, usevMPF, LastPartPos
...
RECURSIVE SUBROUTINE AddBGKOctreeNode(TreeNode, iElem, NodeVol)

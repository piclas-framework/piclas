...
TYPE tSpeciesDSMC                                          ! DSMC Species Parameter
  ...
  REAL                              :: ThermalACCGranularPart        ! thermal accommodation coeﬃcient during granular particle interaction
  REAL                              :: SpecularReflecProbGranularPart! fraction of specularly reﬂected gas atoms during granular particle interaction
  REAL                              :: SpecificHeatSolid             ! the solid particle speciﬁc heat [J/(kg*K)]

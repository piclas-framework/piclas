...
TYPE tRadialWeighting
  ...
  LOGICAL                     :: DoRadialWeighting          ! Enables radial weighting in the CircularSymmetric simulations
  LOGICAL                     :: DoSphericalWeighting       ! Enables radial weighting in the CircularSymmetric simulations

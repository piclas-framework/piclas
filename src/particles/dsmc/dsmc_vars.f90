...
TYPE tSpeciesDSMC !DSMC Species Param
  ...
  INTEGER                     :: InterID              ! Identification number, ini_2
                                                      !     1   : Atom
                                                      !     2   : Molecule
                                                      !     4   : Electron
                                                      !     10  : Atomic ion
...
TYPE tDSMC 
  ...
  LOGICAL                       :: ReservoirSimuRate  ! Does not performe the collision. Enable to create reaction rates curves
  ...
  LOGICAL                       :: CollProbMaxOut     ! Flag for output of Collision Probability max
...
TYPE tBGGas
  ...
  REAL                          :: BGMeanEVibQua    ! Mean EVib qua number for dissociation probability    
END TYPE tBGGas
...
!  INTEGER(KIND=8), ALLOCATABLE    :: NumReac(:)                 ! Number of occured reactions for each reaction number
  ...
  CHARACTER(LEN=1),ALLOCATABLE    :: ReactType(:)               ! Type of Reaction (reaction num)
                                                                ...
                                                                !    E (moleculat exchange reaction)
  INTEGER, ALLOCATABLE            :: DefinedReact(:,:,:)        ! Defined Reaction 
                                            !(reaction num; 1:reactant, 2:product; 1-3 spezieses of reactants and products,

...
CALL prms%CreateLogicalOption(  'DoExactFlux'      , 'TODO-DEFINE-PARAMETER Flag to switch emission to flux superposition at'//&
...
CALL prms%CreateRealOption(     'omega'            , 'TODO-DEFINE-PARAMETER 2*pi*f (f=100 MHz default)' , '6.28318e8')
CALL prms%CreateRealOption(     'tPulse'           , 'TODO-DEFINE-PARAMETER Half length of pulse' , '30e-9')

CALL prms%CreateRealOption(     'TEFrequency'      , 'TODO-DEFINE-PARAMETER  Frequency of TE wave' , '35e9')
CALL prms%CreateRealOption(     'TEScale'          , 'TODO-DEFINE-PARAMETER Scaling of input TE-wave strength' , '1.')
CALL prms%CreateLogicalOption(  'TEPolarization'   , 'TODO-DEFINE-PARAMETER Linear or circular polarized' , '.TRUE.')
CALL prms%CreateIntOption(      'TERotation'       , 'TODO-DEFINE-PARAMETER Left or right rotating TE wave', '1')
CALL prms%CreateLogicalOption(  'TEPulse'          , 'TODO-DEFINE-PARAMETER Flag for pulsed or continuous wave' , '.FALSE.')
CALL prms%CreateIntArrayOption( 'TEMode'           , 'TODO-DEFINE-PARAMETER Input of TE_n,m mode', '1 , 1')
CALL prms%CreateRealOption(     'TERadius'         , 'TODO-DEFINE-PARAMETER Radius of Input TE wave, if wave is '//&
...
CALL prms%CreateRealOption(     'I_0'              , 'TODO-DEFINE-PARAMETER Max. intensity' , '1.')
CALL prms%CreateRealOption(     'sigma_t'          , 'TODO-DEFINE-PARAMETER Can be used instead of tFWHM (time For Full '//&
						     'Wave Half Maximum)' , '0.')
CALL prms%CreateRealOption(     'tFWHM'            , 'TODO-DEFINE-PARAMETER Time For Full Wave Half Maximum' , '0.')
CALL prms%CreateRealOption(     'Beam_a0'          , 'TODO-DEFINE-PARAMETER Value to scale max. electric field' , '-1.0')
CALL prms%CreateRealOption(     'omega_0'          , 'TODO-DEFINE-PARAMETER Spot size and inv of spot size' , '1.0')
CALL prms%CreateStringOption(   'BCStateFile'      , 'TODO-DEFINE-PARAMETER Boundary Condition State File', 'no file found')
...
CALL prms%CreateIntOption(      'FluxDir'          , 'TODO-DEFINE-PARAMETER Flux direction', '-1')
CALL prms%CreateIntOption(      'ExactFluxDir'     , 'TODO-DEFINE-PARAMETER Flux direction for ExactFlux', '3')
CALL prms%CreateRealOption(     'ExactFluxPosition', 'TODO-DEFINE-PARAMETER  x,y, or z-position of interface')

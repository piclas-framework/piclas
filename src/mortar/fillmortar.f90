...
DO MortarSideID=firstMortarSideID,lastMortarSideID
  ...
  CASE(1) !1->4
    ...
    DO q=0,Nloc ! for every eta-layer perform Mortar operation in xi-direction
      ...
      DO p=0,Nloc
        N_Mortar(Nloc)%U_tmp2(:,p,q,1)= N_Mortar(Nloc)%M_1_0(0,p)*N_Mortar(Nloc)%U_tmp(:,0,q,1)+N_Mortar(Nloc)%M_2_0(0,p)*N_Mortar(Nloc)%U_tmp(:,0,q,2)
        N_Mortar(Nloc)%U_tmp2(:,p,q,2)= N_Mortar(Nloc)%M_1_0(0,p)*N_Mortar(Nloc)%U_tmp(:,0,q,3)+N_Mortar(Nloc)%M_2_0(0,p)*N_Mortar(Nloc)%U_tmp(:,0,q,4)
        DO l=1,Nloc
          N_Mortar(Nloc)%U_tmp2(:,p,q,1)=N_Mortar(Nloc)%U_tmp2(:,p,q,1) + N_Mortar(Nloc)%M_1_0(l,p)*N_Mortar(Nloc)%U_tmp(:,l,q,1)+N_Mortar(Nloc)%M_2_0(l,p)*N_Mortar(Nloc)%U_tmp(:,l,q,2)
          N_Mortar(Nloc)%U_tmp2(:,p,q,2)=N_Mortar(Nloc)%U_tmp2(:,p,q,2) + N_Mortar(Nloc)%M_1_0(l,p)*N_Mortar(Nloc)%U_tmp(:,l,q,3)+N_Mortar(Nloc)%M_2_0(l,p)*N_Mortar(Nloc)%U_tmp(:,l,q,4)
        END DO
      END DO
    END DO
    !then in eta
    ...
    DO q=0,Nloc
      DO p=0,Nloc ! for every xi-layer perform Mortar operation in eta-direction
        U_Surf_N(MortarSideID)%Flux_Master(:,p,q)= N_Mortar(Nloc)%M_1_0(0,q)*N_Mortar(Nloc)%U_tmp2(:,p,0,1)+N_Mortar(Nloc)%M_2_0(0,q)*N_Mortar(Nloc)%U_tmp2(:,p,0,2)
        DO l=1,Nloc
          U_Surf_N(MortarSideID)%Flux_Master(:,p,q)=U_Surf_N(MortarSideID)%Flux_Master(:,p,q) + N_Mortar(Nloc)%M_1_0(l,q)*N_Mortar(Nloc)%U_tmp2(:,p,l,1)+N_Mortar(Nloc)%M_2_0(l,q)*N_Mortar(Nloc)%U_tmp2(:,p,l,2)
        END DO
      END DO
    END DO
  ...
  CASE(2) !1->2 in eta
    ...
    DO p=0,Nloc ! for every xi-layer perform Mortar operation in eta-direction
      ...
      DO q=0,Nloc ! for every xi-layer perform Mortar operation in eta-direction
        U_Surf_N(MortarSideID)%Flux_Master(:,p,q)= N_Mortar(Nloc)%M_1_0(0,q)*N_Mortar(Nloc)%U_tmp(:,p,0,1)+N_Mortar(Nloc)%M_2_0(0,q)*N_Mortar(Nloc)%U_tmp(:,p,0,2)
        DO l=1,Nloc
          U_Surf_N(MortarSideID)%Flux_Master(:,p,q)=U_Surf_N(MortarSideID)%Flux_Master(:,p,q) + N_Mortar(Nloc)%M_1_0(l,q)*N_Mortar(Nloc)%U_tmp(:,p,l,1)+N_Mortar(Nloc)%M_2_0(l,q)*N_Mortar(Nloc)%U_tmp(:,p,l,2)
        END DO
      END DO
    END DO
  ...
  CASE(3) !1->2 in xi
    DO q=0,Nloc ! for every eta-layer perform Mortar operation in xi-direction
      ...
      DO p=0,Nloc
        U_Surf_N(MortarSideID)%Flux_Master(:,p,q)= N_Mortar(Nloc)%M_1_0(0,p)*N_Mortar(Nloc)%U_tmp(:,0,q,1)+N_Mortar(Nloc)%M_2_0(0,p)*N_Mortar(Nloc)%U_tmp(:,0,q,2)
        DO l=1,Nloc
          U_Surf_N(MortarSideID)%Flux_Master(:,p,q)=U_Surf_N(MortarSideID)%Flux_Master(:,p,q) + N_Mortar(Nloc)%M_1_0(l,p)*N_Mortar(Nloc)%U_tmp(:,l,q,1)+N_Mortar(Nloc)%M_2_0(l,p)*N_Mortar(Nloc)%U_tmp(:,l,q,2)
        END DO
      END DO
    END DO

...
SUBROUTINE BigToSmallMortar_HDG(nVar_in)
!===================================================================================================================================
...
USE MOD_HDG_Vars  ,ONLY: nGP_Face,IntMatMortar,HDG_Surf_N

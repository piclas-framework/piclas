...
!===================================================================================================================================
!> This subroutine initializes the DMD method
!===================================================================================================================================
SUBROUTINE InitDMD()
!----------------------------------------------------------------------------------------------------------------------------------!
! MODULES                                                                                                                          !
...
VarNameDMD(1) = "ElectricFieldX"
VarNameDMD(2) = "ElectricFieldY"
VarNameDMD(3) = "ElectricFieldZ"
VarNameDMD(4) = "MagneticFieldX"
VarNameDMD(5) = "MagneticFieldY"
VarNameDMD(6) = "MagneticFieldZ"
VarNameDMD(7) = "Phi"
VarNameDMD(8) = "Psi"
...
!===================================================================================================================================
!> This subroutine executes the DMD method
!===================================================================================================================================
...
!===================================================================================================================================
!> This subroutine writes the DMD results to .h5 files
!===================================================================================================================================
...
USE MOD_HDF5_Output_State ,ONLY: WriteTimeAverage,WriteStateToHDF5
...
!USE MOD_2D                 ,ONLY: ExpandArrayTo3D! USE MOD_2D                 ,ONLY: ExpandArrayTo3D
USE MOD_Globals_Vars      ,ONLY: ProjectName
!----------------------------------------------------------------------------------------------------------------------------------!
IMPLICIT NONE
! INPUT / OUTPUT VARIABLES
...
FileName=TRIM(ProjectName)//'_DMD.h5'

! dummy DG_Solution to fix Posti error !!!
!CALL GenerateFileSkeleton(TRIM(FileName)   , 'DMD'   , 1           , N_State      , (/'DUMMY_DO_NOT_VISUALIZE'/) , MeshFile , Time_State )
...
IF (PlotSingleMode) THEN
  ...
  DO i=1,nVarDMD
    ...
    !END IF
    CALL WriteArrayToHDF5(        DataSetName=DataSetName, rank=5,&
...
FileName=TRIM(ProjectName)//'_DMD_Spec.dat'
...
!===================================================================================================================================
!> This subroutine deallocates the DMD variables
!===================================================================================================================================
...
!===================================================================================================================================
!> This subroutine utilizes the Quicksort algorythm: sorts a from first to last entry by the icolumn
!===================================================================================================================================

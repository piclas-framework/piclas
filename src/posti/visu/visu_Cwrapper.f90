...
SUBROUTINE visu_CWrapper(mpi_comm_IN, &
    ...
    coordsDG_out,valuesDG_out,nodeidsDG_out,varnames_out)
! MODULES
USE ISO_C_BINDING
USE MOD_Globals
USE MOD_Visu_Vars
...
! write UVisu to VTK 3D arrays (must be done always!)
! write coords, UVisu to VTK  3D arrays (must be done always!)

...
| **No.** |            **Case**            | **CMAKE-CONFIG** |                            **Feature**                            | **Execution** | **Comparing** |                                      **Readme**                                       |
| :-----: | :----------------------------: | :--------------: | :---------------------------------------------------------------: | :-----------: | :-----------: | :-----------------------------------------------------------------------------------: |
|  10-x   |  CHEM_RATES_dissocication_N2   |                  |    TCE rates for a diatomic dissociation: N2 + N2 -> N + N + N    |   nProcs=1    |               |  [Link](regressioncheck/checks/NIG_Reservoir/CHEM_RATES_dissocication_N2/readme.md)   |
|  10-x   |  CHEM_RATES_dissocication_CH4  |                  |  TCE rates for a polyatomic dissociation: CH4 + M -> CH3 + H + M  |   nProcs=1    |               |  [Link](regressioncheck/checks/NIG_Reservoir/CHEM_RATES_dissocication_CH4/readme.md)  |

...
|    x    |      CHEM_EQUI_exch_CH3-H       | [Reservoir](regressioncheck/checks/WEK_Reservoir/builds.ini) | Relaxation into equilibrium with exchange/radical reaction of CH3+H <-> CH2+H2 |           nProcs=2            |      PartAnalyze_ref.csv       |  [Link](regressioncheck/checks/WEK_Reservoir/CHEM_EQUI_exch_CH3-H/readme.md)  |
|    x    |     CHEM_EQUI_ionization_H      | [Reservoir](regressioncheck/checks/WEK_Reservoir/builds.ini) |       Relaxation into equilibrium with ionization and recombination of H       |           nProcs=1            |      PartAnalyze_ref.csv       | [Link](regressioncheck/checks/WEK_Reservoir/CHEM_EQUI_ionization_H/readme.md) |
|    x    |            cylinder             |      [DSMC](regressioncheck/checks/WEK_DSMC/builds.ini)      |    Hypersonic Argon flow around a cylinder (2D) with DSMC on a curved mesh     |           nProcs=2            |                                |          [DSMC](regressioncheck/checks/WEK_DSMC/cylinder/readme.md)           |
|    x    |            surfflux             |      [DSMC](regressioncheck/checks/WEK_DSMC/builds.ini)      |                                                                                |           nProcs=1            |                                |                                       -                                       |
